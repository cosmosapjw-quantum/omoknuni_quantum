...
private:
    ...
    std::vector<float> count_winning_patterns(
        const std::vector<std::vector<std::vector<int>>>& boards,
    ...
    // More general pattern counting functions
    std::vector<float> count_patterns_general(
        const std::vector<std::vector<std::vector<int>>>& boards,
        const std::vector<int>& player_ids,
        int pattern_length,
        bool count_semi_open = true,
        bool count_blocked = false);
